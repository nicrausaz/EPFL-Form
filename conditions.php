...
<html lang="fr">
    ...
    <?php include('templates/header.php') ?> 
        ...
        <ul id= "cond">
            ...
            <li>Pour les apprentissage de polymécanicien(ne), une attestation de test d'aptitudes GIM-CH est demandée</li>    
        </ul>
       ...
       <p id="incomplet"> Tout dossier incomplet ou non conforme ne sera pas pris en considération !
    </div>
    </body>
</html>